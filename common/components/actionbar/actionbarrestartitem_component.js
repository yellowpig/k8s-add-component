 ...
 * @final
 */
export class ActionbarRestartItemController {
  /**
  ...
  getRestartTooltip() {
     ...
     */
    let MSG_ACTION_BAR_RESTART_TOOLTIP =
        goog.getMsg('Restart {$resourceName}', {'resourceName': this.resourceKindName});
    return MSG_ACTION_BAR_RESTART_TOOLTIP;
  }
}
 ...
 */
export const actionbarRestartItemComponent = {
  templateUrl: 'common/components/actionbar/actionbarrestartitem.html',
  bindings: {
    'resourceKindName': '@',
    'typeMeta': '<',
    'objectMeta': '<',
  },
  controller: ActionbarRestartItemController,
};
