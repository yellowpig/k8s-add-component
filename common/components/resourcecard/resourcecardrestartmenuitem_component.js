 ...
 * @final
 */
export class ResourceCardRestartMenuItemController {
  /**
  ...
  remove() {
    this.kdResourceVerberService_
        ...
        .catch((err) => {
          if (err) {
            this.log_.error('Error showing restart dialog:', err);
          }
        });
  }
}
 ...
 */
export const resourceCardRestartMenuItemComponent = {
  templateUrl: 'common/components/resourcecard/resourcecardrestartmenuitem.html',
  bindings: {
    'resourceKindName': '@',
  },
  ...
  controller: ResourceCardRestartMenuItemController,
};
